 ...
 * @date 2021-03-30
 *
 * @copyright Copyright (c) 2020 Sejong Heo, Jaehyung Jung
 *
...
#define ER (double)(7.292115e-5)
#define R0 (double)(6378137.0)        // [m]
#define ECC (double)(0.0818191908426) // earth eccentricity
